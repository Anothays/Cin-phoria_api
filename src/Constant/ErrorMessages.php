...
class ErrorMessages 
{
  ...
  const TICKETS_COUNT_DOES_NOT_MATCH_RESERVED_SEATS_COUNT = "Le nombre de billets ne correspond pas au nombre de sièges réservés";
  ...
  const NO_SEAT_SELECTED = "Aucun siège sélectionné";
}
